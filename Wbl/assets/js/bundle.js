(function e(t, n, r) {
    ...
    }, { "jquery": 3, "jquery-simple-timer": 2 }],
    ...
    3: [function(require, module, exports) {
        ...
        (function(global, factory) {
            ...
            (function() {
                ...
                training.htmlSerialize = !!div.getElementsByTagName("link").length;
            ...
            var wrapMap = {
                ...
                _default: training.htmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"]
            };
            ...
            function fixCloneNodeIssues(src, dest) {
                ...
                if (nodeName === "script" && dest.text !== src.text) {
                    ...
                    if (training.html5Clone && (src.innerHTML && !jQuery.trim(dest.innerHTML))) {
            ...
            jQuery.extend({
                ...
                clone: function(elem, dataAndEvents, deepDataAndEvents) {
                    ...
                    if (training.html5Clone || jQuery.isXMLDoc(elem) ||
                ...
                html: function(value) {
                    return access(this, function(value) {
                        ...
                        if (typeof value === "string" && !rnoInnerhtml.test(value) &&
                            (training.htmlSerialize || !rnoshimcache.test(value)) &&
